  ...
  const slides = [
    {
      ...
      detail: "Follow Rich O'Toole as he tours the country trying the best taco spots — with your recommendations!",
      bg: "https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=800&q=70",
    },
    {
      emoji: "📍⭐",
      title: "Discover. Rate. Debate.",
      subtitle: "Rich's reviews on an interactive map",
    ...
    {
      emoji: "🗳️🌮",
      title: "Recommend Spots for Rich",
      subtitle: "Vote on where Rich should eat next",
      detail: "Search real restaurants near each tour stop, upvote your favorites, and help Rich find the best tacos in town.",
